							...
							<div class="contact-info">
								...
								<div class="block">
									<ul class="list-unstyled list-inline my-4 social-icons">
										...
										<li class="list-inline-item me-3"><a title="Explorer Twitter Profile" class="text-black" target="_blanck" href="https://twitter.com/kaledmoly"><i class="fab fa-twitter"></i></a>
										</li>
